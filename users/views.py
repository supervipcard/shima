...
class SignInView(View):
    def get(self, request):
        ...
        return render(request, 'user/login.html', {"code_id": code_id, 'next_page': next_page})
...
class ForgetPasswordView(View):
    def get(self, request):
        code_id = str(uuid.uuid1())
        return render(request, 'user/forget.html', {'code_id': code_id})
...
class ForgetPasswordView2(View):
    def get(self, request):
        ...
        if phone:
            return render(request, 'user/forget2.html', {'phone': phone})
        else:
